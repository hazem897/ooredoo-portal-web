// backend/config/db.js - VERSION CORRIGÉE ET COMPLÈTE
...
function query(sql, params, callback) {
  ...
  try {
    ...
    pool.query(formattedQuery.text, formattedQuery.values, (err, result) => {
      if (callback) callback(err, result?.rows || result);
    });
  } catch (err) {
