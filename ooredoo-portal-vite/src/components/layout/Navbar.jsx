...
function Navbar({ toggleSidebar }) {
  ...
  const notifications = [
    { id: 1, texte: "Bienvenue sur le nouveau portail Ooredoo !" },
    { id: 2, texte: "Un nouveau ticket a été créé." },
    { id: 3, texte: "Rapport mensuel prêt." }
  ];
              ...
              <div className="notification-dropdown">
                ...
                <ul className={unreadCount > 0 ? 'has-unread' : ''}>
                  {notifications.map(notif => (
                    <li key={notif.id}>{notif.texte}</li>
                  ))}
                </ul>
