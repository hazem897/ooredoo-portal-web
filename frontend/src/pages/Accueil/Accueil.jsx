      ...
      <header className={`header-accueil ${isScrolled ? 'scrolled' : ''}`}>
        <div className="header-container">
          ...
          <div className="header-actions-nav">
            {user ? (
              <Link to="/dashboard" className="btn-rejoindre btn-dashboard-retour">
      ...
      <section className="hero" id="accueil">
        <div className="hero-contenu">
          ...
          <div className="hero-actions">
            {user ? (
              <Link to="/dashboard" className="btn-rouge btn-dashboard-retour-hero">{t('dashboard') || 'Dashboard'} →</Link>
            ) : (
